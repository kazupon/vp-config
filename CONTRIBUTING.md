...
- Check if the issue is reproducible with the latest stable version of `@kazupon/vp-config`. If you are using a pre-release, please indicate the specific version you are using.
...
- Submit a pull request to `main` branch of `kazupon/vp-config` repository !
